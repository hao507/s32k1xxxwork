...
//	S32_NVIC->ISER[1] = 1 << (CAN0_ORed_0_15_MB_IRQn % 32);  /* enable IRQ */
	S32_NVIC->ISER[(uint32_t)(CAN0_ORed_0_31_MB_IRQn) >> 5U] = (uint32_t)(1U << ((uint32_t)(CAN0_ORed_0_31_MB_IRQn) & (uint32_t)0x1FU));
	S32_NVIC->ICPR[(uint32_t)(CAN0_ORed_0_31_MB_IRQn) >> 5U] = (uint32_t)(1U << ((uint32_t)(CAN0_ORed_0_31_MB_IRQn) & (uint32_t)0x1FU));
//	S32_NVIC->IP[CAN0_ORed_0_31_MB_IRQn] = 0xA;              /* priority 10 of 0-15*/
...
{
	S32_NVIC->ICER[(uint32_t)(CAN0_ORed_0_31_MB_IRQn) >> 5U] = (uint32_t)(1U << ((uint32_t)(CAN0_ORed_0_31_MB_IRQn) & (uint32_t)0x1FU));
	S32_NVIC->ICER[(uint32_t)(CAN0_ORed_0_31_MB_IRQn) >> 5U] = (uint32_t)(1U << ((uint32_t)(CAN0_ORed_0_31_MB_IRQn) & (uint32_t)0x1FU));
