...
unsigned char wdata[8] = {0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08};
	...
	{
		CanbusSend(CANBUS0,type1_Can_Send_Id_1,(unsigned char *)wdata,8,CAN_STANDARD_MODE);
		type1_send_flag_0 = 0;
	}
	int queueLen;
	if(TYPE1_Canread_statust0 == 1)
	{			
		int ret = canbusReadIrq(CANBUS0,(int *)&TYPE1_TYPE1_Can_read_Id,TYPE1_Read_data0,&queueLen);
